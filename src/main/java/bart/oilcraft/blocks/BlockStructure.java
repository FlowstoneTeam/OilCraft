 ...
 */
public class BlockStructure extends Block implements OilCraftBlockRegistry.ISubBlocksBlock {

    public static final String[] iconPaths = new String[]{"valveInput", "valveOutput"};
    public IIcon[] icons;

    public BlockStructure() {
        super(Material.iron);
        this.setBlockName("oilcraft.blockStructure");
