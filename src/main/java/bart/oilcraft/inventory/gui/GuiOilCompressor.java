...
public class GuiOilCompressor extends OCGui {
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        String s = this.tileOilCompressor.hasCustomName() ? this.tileOilCompressor.getName() : I18n.format(this.tileOilCompressor.getName(), new Object[0]);
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        int k = (this.width - this.xSize) / 2;
        int l = (this.height - this.ySize) / 2;
        this.drawTexturedModalRect(k, l, 0, 0, this.xSize + 20, this.ySize);
    }
